import { Body, Controller, Get, Param, ParseIntPipe, Patch, Post, Query, Req, Request, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class ReservationsController {
  ...
  @Get()
  getReservation(
    @Query() query: ReservationPaginateDto,
    @Req() req,
  ) {
